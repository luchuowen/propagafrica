# Prompts 1-6 — homepage, products, tools, Field Notes, About/Contact

Archived from .factory/DECISIONS.md during Prompt 7 (QA/production-readiness)
compaction — see that file for the current pointer. These decisions still hold.
