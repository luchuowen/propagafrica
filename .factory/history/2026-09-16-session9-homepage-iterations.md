# Session 9 — homepage/about UI iteration decisions (archived 2026-09-16)

Moved out of `.factory/DECISIONS.md` to stay under its 250-line cap. Superseded
where a later DECISIONS.md entry says so (e.g. the journey loop's card width and
the footer's sitemap disclosure both changed again after these were written).
