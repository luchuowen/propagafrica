...
5. "Technical support from setup to season one"
   ...
   Monitoring spotlight (dark section). Heading: "See what's happening in your nursery, not just what happened last week." Body: "PropagAfrica Monitoring pairs temperature, humidity, VPD, soil-moisture, EC and PAR sensors with a mobile and web dashboard, alerts and historical reporting -- hardware, software and support in one package." Example dashboard readings, each clearly labelled "Example reading": Graft Success 98.4%. Average zone temp 24.6C.
   Services 3-up teaser: first 3 items of the Technical Services "Our Services" list below, links to /products/technical-services/. Laid out as a photograph (technical-services/01.jpg) beside the numbered index rather than the index at full width, which stranded each arrow ~900px from its label. Carries Section 9's verbatim intro ("From training to troubleshooting, we support your propagation journey.") under the heading. No new copy. The photograph takes its height from the index beside it rather than a fixed ratio, so the section is sized by its content.
