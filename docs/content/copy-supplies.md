# Copy deck — Supplies (6 pages)

Final copy and final specifications. Place them, do not rewrite them, do not add figures that are not
here. Sheets 02–07.

Every stage page follows the same skeleton:

1. Eyebrow · H1 · plain-English standfirst · title block
2. One full-width figure with sheet footer
3. The specification table
4. A short notes block beneath the table, mono, `--ink-soft`
5. `Ask for a quotation` block

---

# /supplies — overview · SHEET 02 OF 14

Eyebrow `WHAT WE SUPPLY`
H1 **Everything a propagation house gets through in a month.**
Standfirst
...
Then the five stage entries exactly as on the home page, each with its full SKU list and a link.

Closing note, mono
`EQUIPMENT AT STAGE 03 IS SPECIFIED AND SOURCED TO YOUR HOUSE. CONSUMABLES ARE HELD IN NAIROBI STOCK.`

---

# /supplies/prepare · SHEET 03 OF 14

Eyebrow `STAGE 01 · PREPARE`
H1 **Growing media, trays and tools.**
Standfirst
...
GRADES     6
PACK       20 kg · 50 L · 250 L
SHEET      03 OF 14
```

**Figure PA-003** — section through a 128-cell tray: two cells in section, medium filled to 98 mm, 6 mm headspace dimensioned in `--signal`, drainage slots at the base, annotation `≈ 20 ml / cell`.
Caption `FIG. 03 · CELL SECTION, 128-CELL TRAY · SCALE 1:1.6 · REV. A`

Figure note
Under-filling costs root volume. Over-filling closes the drainage path and waterlogs the base of the cell. Six millimetres of headspace is the working target.
...
# /supplies/graft · SHEET 04 OF 14

Eyebrow `STAGE 02 · GRAFT`
H1 **Grafting sleeves and clips.**
Standfirst
...
**Figure PA-004** — the graft join in elevation at 2:1, as on the home page but larger, with the sleeve, bore, length and cut angle all dimensioned.
Caption `FIG. 04 · SPLICE GRAFT IN A PRO-ROSE 45 SLEEVE · SCALE 2:1 · REV. A`

Figure note
Choose the bore against the larger of scion and rootstock at the cut. A sleeve one size over slips and the join moves. One size under and it presses on the layer that has to grow.

Link to the sleeve selector: `Find the right sleeve →`
...
Second note
Grafted vegetables are cut at roughly 30° just above the seed leaves and secured with a clip or a flexible sleeve. In Kenya this is still an emerging practice rather than an established one — the documented work is a demonstration programme run by Egerton University with Nanjing Agricultural University across 18 sites in Nakuru, Kisumu, Bomet and Subukia. Rose and fruit-tree grafting are the established, repeat-volume operations.

---

# /supplies/root · SHEET 05 OF 14

Eyebrow `STAGE 03 · ROOT`
H1 **Misting, benching, irrigation and monitoring.**
Standfirst
...
BASIS      SPECIFIED AND SOURCED
CONTROL    VAPOUR PRESSURE DEFICIT
SHEET      05 OF 14
```

**Figure PA-005** — mist bench in elevation: bench, three trays, mist line with three nozzles and spray cones, nozzle pitch dimensioned 1.1 m in `--signal`, a sensor drawn at canopy height with a leader, and a dashed control loop from sensor back to the valve.
Caption `FIG. 05 · MIST BENCH, ELEVATION · SCALE 1:20 · REV. A`

Figure note
The sensor belongs at canopy height, not at the gable. The two read differently, and the plant lives at the canopy.

### What we specify and source

Equipment at this stage is designed around your house and sourced to that design. It is not held in stock.
...
Second note
`THIS IS THE ONE STAGE WHERE WE DESIGN BEFORE WE QUOTE. SEND US THE HOUSE DIMENSIONS AND THE CROP.`

---

# /supplies/protect · SHEET 06 OF 14

Eyebrow `STAGE 04 · PROTECT`
H1 **Nursery hygiene.**
Standfirst
...
**Figure PA-006** — dilution schematic: concentrate drum, a measuring cylinder showing 83 ml, a plus sign, a 10 L water vessel, an arrow, and the resulting 1 000 ppm working solution. The arithmetic printed above in `--signal`.
Caption `FIG. 06 · DILUTION SCHEMATIC, TOOL DIP · REV. A`

Figure note
The arithmetic is printed because the failure mode is a supervisor guessing a capful. A dip made at a tenth of the intended strength is not biosecurity, it is the appearance of it.
...
Second note
Farms exporting roses to the European Union work under a systems approach that became mandatory on 26 April 2025 under Regulation (EU) 2024/2004. Nurseries certified to GLOBALG.A.P. Integrated Farm Assurance for Plant Propagation Material are assessed against control points covering hygiene procedure, cleaning of reusable materials, disinfection of equipment between batches, and the batch number of the substrate used. Those are the requirements this range is bought against.

---

# /supplies/record · SHEET 07 OF 14

Eyebrow `STAGE 05 · RECORD`
H1 **Labels, batch cards and record books.**
Standfirst
...
**Figure PA-007** — the traceability chain: mother block → tray label → batch card → QC logbook → despatch record, connected with arrows, with a band beneath showing one lot code running through all five, and a dashed leader marked `SUPPLIER BATCH ON EVERY ITEM`.
Caption `FIG. 07 · THE CHAIN AN AUDITOR WALKS · REV. A`

Figure note
If the supplier's batch code is missing, the chain breaks at the first link — and the finding lands on the grower, not on the supplier.
...
## Metadata for every stage page

```
title        <Stage name> | PropagAfrica Technologies
description  <the standfirst, trimmed to 155 characters>
```
